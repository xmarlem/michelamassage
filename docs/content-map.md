...
Lingua predefinita: tedesco (`lang = 'de'` e `<html lang="de">`).
...
- zertifizierte Lymphdrainage;
- solo su appuntamento, ogni martedì.
...
Il submit non invia dati a un server. Genera un link `mailto:` con subject e body precompilati.
