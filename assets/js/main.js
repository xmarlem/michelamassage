...
function buildQR(l) {
  ...
  if (typeof QRCode === 'undefined') {
    ...
    link.href = l === 'de' ? QR_DE : QR_IT;
    link.textContent = l === 'de' ? 'E-Mail öffnen' : 'Apri email';
...
function setLang(l) {
  ...
  document.querySelectorAll('[data-ph-i]').forEach(function(el) {
    el.placeholder = el.getAttribute(l === 'it' ? 'data-ph-i' : 'data-ph-d');
  });
